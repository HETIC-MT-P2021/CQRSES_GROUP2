...
// QueryMessage define the structure of query message entities
type QueryMessage interface {
	Payload() interface{}
	QueryType() string
}

// QueryBus define the structure of query bus entities
type QueryBus struct {
	handlers map[string]QueryHandler
}

// QueryDescriptor define the structure of query descriptor entities
type QueryDescriptor struct {
	query interface{}
}

// NewQueryBus action a new query bus
...
// NewQueryMessage action a new query message
