...
// CommandMessage define the structure of the command message entities
type CommandMessage interface {
	CommandType() string
	Payload() interface{}
}

// CommandBus define the structure of the command bus entities
type CommandBus struct {
	handlers map[string]CommandHandler
}

// CommandDescriptor define the structure of the command descriptor entities
